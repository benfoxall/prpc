...
goog.exportSymbol('proto.PRPCStreamChunk.Type', null, global);
...
proto.PRPCStreamChunk.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = /** @type {!proto.PRPCStreamChunk.Type} */ (reader.readEnum());
      msg.setType(value);
      break;
    case 2:
      var value = /** @type {!Uint8Array} */ (reader.readBytes());
 ...
 * @return {!proto.PRPCStreamChunk.Type}
 */
proto.PRPCStreamChunk.prototype.getType = function() {
  return /** @type {!proto.PRPCStreamChunk.Type} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {!proto.PRPCStreamChunk.Type} value */
proto.PRPCStreamChunk.prototype.setType = function(value) {
